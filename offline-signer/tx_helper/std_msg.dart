...
class StdMsg {
  ...
  Map<String, dynamic> toJson() => {
        ...
        'extension_options': this.extensionOptions?.map((option) => option.toJson())?.toList(),
        'non_critical_extension_options': this.nonCriticalExtensionOptions?.map((option) => option.toJson())?.toList(),
      };

...
class ModeInfo {
  ...
  factory ModeInfo.fromJson(Map<String, dynamic> json) => ModeInfo(single: Single.fromJson(json['single'] as Map<String, dynamic>));
...
class SignerInfo {
  ...
  const SignerInfo({@required this.publicKey, @required this.modeInfo, @required this.sequence})
      : assert(publicKey != null),
        assert(modeInfo != null),
        assert(sequence != null);

  factory SignerInfo.fromJson(Map<String, dynamic> json) => SignerInfo(
        publicKey: StdPublicKey.fromJson(json['public_key'] as Map<String, dynamic>),

...
import 'package:offline_tool/tx_helper/msg_signer.dart';
import 'package:offline_tool/utils/bech32_encoder.dart';

import 'package:offline_tool/services/network_info.dart';
import 'package:pointycastle/export.dart';
import 'package:offline_tool/utils/pc_utils.dart' as pcUtils;
...
class Account {
  ...
  bool operator ==(Object o) {
    ...
    return o is Account && o.name == name && o.version == version && o.algorithm == algorithm && o.secretKey == secretKey && o.encryptedMnemonic == encryptedMnemonic && o.checksum == checksum && o.hexAddress == hexAddress && o.privateKey == privateKey && o.publicKey == publicKey;
  }

  @override
  int get hashCode => name.hashCode ^ version.hashCode ^ algorithm.hashCode ^ secretKey.hashCode ^ encryptedMnemonic.hashCode ^ checksum.hashCode ^ privateKey.hashCode ^ publicKey.hashCode;
